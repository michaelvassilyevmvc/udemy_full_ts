...
function calculateAmountOfFigures<T extends  Figure>(figure:T[] ): AmountOfFigures {
  ...
  figure.forEach((f) => {
    switch (f.name) {
      case FigureNames.Rect: amount.squares++;break;
      case FigureNames.Triangle: amount.triangles++;break;
      case FigureNames.Circle: amount.circles++;break;
      default: amount.others++;break;
    }
  })
